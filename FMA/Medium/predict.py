...
#model name
if useDefault == True:
    modelName = 'MediumPretrainedCNN.h5'
    genres = ["Blues", "Classical", "Country", "Easy Listening", "Electronic", "Experimental", "Folk", "Hip-Hop", "Instrumental", "International", "Jazz", "Old-Time", "Pop", "Rock", "Soul-RnB", "Spoken"]
    genres.sort()
else:
