...
#model name
if useDefault == True:
    modelName = 'LargePretrainedCNN.h5'
    genres = ["Blues", "Classical", "Country", "Dubstep", "Electronic", "Flamenco", "Funk", "Hip-Hop", "Jazz", "Lo-Fi", "Loud-Rock", "Metal", "Old-Time", "Opera", "Pop", "Post-Punk", "Punk", "Rock", "Rockabilly", "Sludge", "Soul-RnB"]
    genres.sort()
else:
